...
$zadminModel = unserialize($_SESSION['LOGIN_EMPLOYEE']);
...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="#" class="logo" style="background-color:rgb(0, 125, 125)">
    ...
    <nav class="navbar navbar-static-top" style="background-color:rgb(0, 145, 145)">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="dist/img/employee-icon.png" class="img-circle" alt="User Image">
        </div>
