...
<div class="box box-info">
  <div class="box-header with-border">
      <h3 class="box-title">คำนวนค่าตรวจสภาพรถ</h3>
  </div>
  <form class="form-group" action="index.php?menu=cal-check-car&calculate=yes" method="post">
    <div class="box-body">
      <br>
      เลือกประเภทรถ
      ...
      <br>
      <input class="btn btn-info" type="submit" value="คำนวน"> 
    </div>
  </form>
  <!-- /.box-body -->
</div>
...
<?php
          ...
          <!-- show search by car number -->
            ...
            <div class="box-header with-border">
                <h3 class="box-title"> ค่าตรวจสภาพรถ: <strong><?php echo number_format($row['price_check_car']) ?></strong> บาท</h3>
            </div>
